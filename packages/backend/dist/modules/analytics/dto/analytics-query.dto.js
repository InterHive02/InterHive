...
class AnalyticsQueryDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { page: { required: false, type: () => Number, default: 1, minimum: 1 }, limit: { required: false, type: () => Number, default: 10, minimum: 1 }, status: { required: false, type: () => String }, type: { required: false, type: () => String }, month: { required: false, type: () => Number, minimum: 1, maximum: 12 }, year: { required: false, type: () => Number, minimum: 2020 }, startDate: { required: false, type: () => Date }, endDate: { required: false, type: () => Date }, category: { required: false, type: () => String }, department: { required: false, type: () => String } };
    }
}
